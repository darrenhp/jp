...
window.JP_DATA = {
  ...
  /* ---------- 输入法键盘图示（SVG 渲染） ---------- */
  inputKeyboards: [
    { id:"romaji", type:"qwerty",
      name:"罗马字输入（QWERTY 键盘）",
      desc:"最常用的桌面输入方式。在普通英文键盘上键入罗马字，IME 即时转换为假名，再选汉字。无需记忆特殊键位。",
      example:"例：键入 <code>konnichiwa</code> → こんにちは；<code>tt</code> 输入促音 → っと（如 <code>kitte</code> 切手）。",
      rows:[
        [{t:"1"},{t:"2"},{t:"3"},{t:"4"},{t:"5"},{t:"6"},{t:"7"},{t:"8"},{t:"9"},{t:"0"},{t:"-"}],
        [{t:"Q"},{t:"W"},{t:"E"},{t:"R"},{t:"T"},{t:"Y"},{t:"U"},{t:"I"},{t:"O"},{t:"P"}],
        [{t:"A"},{t:"S"},{t:"D"},{t:"F"},{t:"G"},{t:"H"},{t:"J"},{t:"K"},{t:"L"}],
        [{t:"Z"},{t:"X"},{t:"C"},{t:"V"},{t:"B"},{t:"N"},{t:"M"}],
        [{t:"Space",w:7}]
      ] },
    { id:"kana", type:"kana",
      name:"假名直输（JIS かな配列）",
      desc:"日规（JIS）键盘直接在键帽上印有假名。按下对应键即输入该假名，省去罗马字转换环节，熟练后速度更快。每个键上都标注了该假名的罗马字读法。",
      example:"例：按数字「3」键 → <b>あ</b>；按字母「e」键 → <b>い</b>；按「t」键 → <b>か</b>。",
      rows:[
        [{t:"ぬ",s:"nu"},{t:"ふ",s:"fu"},{t:"あ",s:"a"},{t:"う",s:"u"},{t:"え",s:"e"},{t:"お",s:"o"},{t:"や",s:"ya"},{t:"ゆ",s:"yu"},{t:"よ",s:"yo"},{t:"わ",s:"wa"},{t:"ほ",s:"ho"}],
        [{t:"た",s:"ta"},{t:"て",s:"te"},{t:"い",s:"i"},{t:"す",s:"su"},{t:"か",s:"ka"},{t:"ん",s:"n"},{t:"な",s:"na"},{t:"に",s:"ni"},{t:"ら",s:"ra"},{t:"せ",s:"se"},{t:"゛",s:"゜"}],
        [{t:"ち",s:"chi"},{t:"と",s:"to"},{t:"し",s:"shi"},{t:"は",s:"ha"},{t:"き",s:"ki"},{t:"く",s:"ku"},{t:"ま",s:"ma"},{t:"の",s:"no"},{t:"り",s:"ri"},{t:"れ",s:"re"}],
        [{t:"つ",s:"tsu"},{t:"さ",s:"sa"},{t:"そ",s:"so"},{t:"ひ",s:"hi"},{t:"こ",s:"ko"},{t:"み",s:"mi"},{t:"も",s:"mo"},{t:"ね",s:"ne"},{t:"る",s:"ru"},{t:"め",s:"me"}],
        [{t:"へ",s:"he"},{t:"ー",s:"長音"},{t:"Space",w:5}]
      ] },
    { id:"mobile", type:"mobile",
      name:"手机九宫格（フリック输入）",
      desc:"手机日语键盘采用 3×4 九宫格。每格中央为一个「あ段」假名，向 上 / 右 / 下 / 左 四个方向滑动即可输入该行其余元音（い/う/え/お）。方向键也可长按选小写假名。",
      example:"例：在「か」键上向右滑 → <b>く</b>；向下滑 → <b>け</b>；「や」向上滑 → <b>よ</b>。",
      keys:[
        {c:"あ",f:["い","う","え","お"]},{c:"か",f:["き","く","け","こ"]},{c:"さ",f:["し","す","せ","そ"]},
        {c:"た",f:["ち","つ","て","と"]},{c:"な",f:["に","ぬ","ね","の"]},{c:"は",f:["ひ","ふ","へ","ほ"]},
        {c:"ま",f:["み","む","め","も"]},{c:"や",f:["よ","ゆ",null,"ゃ"]},{c:"ら",f:["り","る","れ","ろ"]},
        {c:"わ",f:["を","ん",null,"ゎ"]},{c:"記号",special:true},{c:"小",special:true}
      ] }
  ],
